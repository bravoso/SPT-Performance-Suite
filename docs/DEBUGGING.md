...
Press Num9 to write a self-contained diagnostic report under `BepInEx/plugins/TarkovPerformanceSuite/diagnostics`. It contains loaded plugins/patchers, live Harmony owners, available counters, feature/entity state, recent exceptions, fingerprints, and suite overhead.
