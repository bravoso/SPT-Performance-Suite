...
/// <summary>Stores calculated frame-time statistics for a completed sample window.</summary>
...
/// <summary>Maintains a bounded rolling frame-time window and calculates FPS percentiles.</summary>
...
/// <summary>Provides deterministic percentile interpolation for sorted numeric samples.</summary>
public static class Percentiles
{
    public static double FromSorted(double[] sortedValues, int count, double percentile)
    {
        ...
        if (count <= 0 || count > sortedValues.Length)
        {
